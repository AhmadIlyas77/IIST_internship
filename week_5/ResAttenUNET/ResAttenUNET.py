...
image_directory = 'training_set/training_set/'
mask_directory = 'training_set/masks/'
...
from Res_Atten_model import Attention_ResUNet, UNet, Attention_UNet, dice_coef, dice_coef_loss, jacard_coef
